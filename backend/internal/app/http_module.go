...
func BuildHTTPModule(deps HTTPDeps) *HTTPModule {
	...
	module := httpmodule.BuildHTTPModule(httpmodule.HTTPDeps{
		...
		Ujian: routes.UjianHandlers{
			...
			ListPesertaUjianSubmittedHandler: deps.Ujian.ListPesertaUjianSubmittedHandler,
			...
			SubmitUjianHandler:               deps.Ujian.SubmitUjianHandler,
			GetJawabanUjianHandler:           deps.Ujian.GetJawabanUjianHandler,
			HasilJawabanUjianHandler:         deps.Ujian.HasilJawabanUjianHandler,
			...
			ListUjianSelesaiSiswaHandler:     deps.Ujian.ListUjianSelesaiSiswaHandler,
			GetStatistikUjianHandler:         deps.Ujian.GetStatistikUjianHandler,
			AnalisisSoalHandler:              deps.Ujian.AnalisisSoalHandler,
			...
			ListSoalUjianSiswaHandler:        deps.Ujian.ListSoalUjianSiswaHandler,
			GetWaktuSelesaiUjianHandler:      deps.Ujian.GetWaktuSelesaiUjianHandler,
