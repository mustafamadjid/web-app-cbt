...
import (
	...
	fake_test "github.com/mustafamadjid/web-app-cbt/internal/core/service/kelas/update/fake_test"
)
...
func TestUpdateKelasService_UpdateNamaKelas(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			repo:            &fake_test.FakeKelasRepo{UpdateErr: coreerror.ErrNotFound},
		...
		},
		{
			...
			repo:            &fake_test.FakeKelasRepo{UpdateErr: repoErr},
			wantErr:         repoErr,
			wantRepoCalled:  true,
