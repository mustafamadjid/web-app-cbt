...
import (
	...
	expire "github.com/mustafamadjid/web-app-cbt/internal/adapter/handler/http/features/ujian/attempt_ujian/attempt/expire"
...
func TestExpireAttemptUjianHandler(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			handler := expire.NewExpireAttemptUjianHandler(attemptujian_service.NewExpireAttemptUjianService(updater))
