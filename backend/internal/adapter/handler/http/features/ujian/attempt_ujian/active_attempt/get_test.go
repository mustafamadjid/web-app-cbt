...
func TestGetActiveAttemptUjianHandler(t *testing.T) {
	...
	tests := []struct {
		...
		wantCode     string
		wantMessage  string
		assertResult func(t *testing.T, data GetActiveAttemptUjianResponse)
	}{
		{
			name:        "missing actor",
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			handler := NewGetActiveAttemptUjianHandler(activeattempt_service.NewGetActiveAttemptUjianService(tc.repo))
...
func decodeActiveAttemptResponse(t *testing.T, resp activeAttemptAPIResp) GetActiveAttemptUjianResponse {
	t.Helper()

	var data GetActiveAttemptUjianResponse
