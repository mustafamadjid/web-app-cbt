...
import (
	...
	update "github.com/mustafamadjid/web-app-cbt/internal/adapter/handler/http/features/ujian/attempt_ujian/attempt/update"
...
func TestUpdateAttemptUjianHandler(t *testing.T) {
	...
	for _, tc := range tests {
		...
		t.Run(tc.name, func(t *testing.T) {
			...
			handler := update.NewUpdateAttemptUjianHandler(svc)
