      ...
      <div className="w-full max-w-xl rounded-xl border border-slate-200 bg-white p-6 shadow-2xl">
        ...
        <div className="mt-6 flex justify-end gap-3">
          ...
          <button
            ...
            onClick={onConfirm}
            disabled={isLoading}
            className="cursor-pointer rounded-lg bg-rose-600 px-4 py-2 text-sm font-medium text-white transition hover:bg-rose-700 disabled:cursor-not-allowed disabled:opacity-60"
          >
