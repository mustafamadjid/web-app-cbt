...
export const PrintButton = ({
  ...
  return (
    <button
      type="button"
      onClick={onClick}
      className={`inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2 text-sm font-semibold transition focus-visible:outline-none focus-visible:ring-4 ${variantStyles[variant]} ${className}`}
    >
      <Printer size={16} />
      {label}
    </button>
